...
public class SoldierController : MonoBehaviour
{
    ...
    void Update()
    {
...

        {
            ...
            soldierRange.GetComponent<CircleCollider2D>().enabled = false;
            GetComponent<CapsuleCollider2D>().enabled = false;
            this.enabled = false;
        }

        if (skin.GetComponent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("AtakSoldier"))
        {
            return;
        }
